...
const { sendFriendRequest, respondFriendRequest, getFriendRequests, getFriends, getSentRequests } = require('../controllers/friends.controller');
...
// Sent Requests List Route
router.get('/sent-requests', isAuth, getSentRequests);
